...
1. Git clone ````https://github.com/Dimushok1221/Laba3````
...
* Первая кнопка ````Button1```` перекидывает на окно со списком данных.
* Вторая кнопка ````Button2```` перекидывает на окно со строчкой ввода «Введите запись» и кнопкой «Добавить запись».
* Третья кнопка ````Button3```` меняет последнюю строку в списке данных «ФИО» на Иванов Иван Иванович. 
